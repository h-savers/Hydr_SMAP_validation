...
SMAPSMtripleTOT=[SMAPSMtripleTOT SMAPSMtriple] ;
SMOSSMtripleTOT=[SMOSSMtripleTOT SMOSSMtriple] ;
HydroSMtripleTOT=[HydroSMtripleTOT HydroSMtriple] ;
...
% SMOSSMtripleTOT=SMOSSMtripleTOT- mean(SMOSSMtripleTOT-SMAPSMtripleTOT) ;        %%  This is Y
% HydroSMtripleTOT=HydroSMtripleTOT- mean(HydroSMtripleTOT-SMAPSMtripleTOT)  ;      %%  This is Z

corr_XY=corrcoef(SMAPSMtripleTOT, SMOSSMtripleTOT) ; corr_XY=corr_XY(1,2) ; 
corr_XZ=corrcoef(SMAPSMtripleTOT, HydroSMtripleTOT) ; corr_XZ=corr_XZ(1,2) ;  
corr_YZ=corrcoef(SMOSSMtripleTOT, HydroSMtripleTOT) ; corr_YZ=corr_YZ(1,2) ; 

% sigma2_X=var(SMOSSMtripleTOT)  ; 
